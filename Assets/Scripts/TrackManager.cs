...
public class TrackManager : MonoBehaviour
{
    ...
    public IEnumerator Begin()
    {
        if (!m_Rerun)
        {
            ...
            this.player.trackManager = this;

            this.player.Init();
            this.player.CheatInvincible(invincible);
            ...
            player.transform.SetParent(this.player.characterCollider.transform, false);
            Camera.main.transform.SetParent(this.player.transform, true);
